"""
CatBoost baseline: multi-class classification with walk-forward validation.
"""
...
def run(data_path: str | None = None, n_splits: int = 5) -> list[dict]:
    """Train CatBoost with walk-forward validation; print metrics; return metrics per fold."""
    ...
    for fold, (train_idx, test_idx) in enumerate(splits):
        ...
        y_pred = model.predict(X_test_s).astype(int).ravel()
    ...
    print_metrics(metrics_per_fold, "CatBoost")
