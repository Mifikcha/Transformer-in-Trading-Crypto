"""
Logistic Regression baseline: multi-class classification with StandardScaler and walk-forward validation.
"""
...
def run(data_path: str | None = None, n_splits: int = 5) -> list[dict]:
    """Train Logistic Regression with walk-forward validation; print metrics; return metrics per fold."""
    ...
    print_metrics(metrics_per_fold, "Logistic Regression")
