"""
LightGBM baseline: multi-class classification with walk-forward validation.
"""
...
def run(data_path: str | None = None, n_splits: int = 5) -> list[dict]:
    """Train LightGBM with walk-forward validation; print metrics; return metrics per fold."""
    ...
    print_metrics(metrics_per_fold, "LightGBM")
